...
path = '/Users/lucaslumertz/Documents/1Programacao/challanges/DESAFIO-PLACE/data/input/20251001_atividade_economica.csv' 
...
output_path = os.path.join(output_dir, 'df_empresas_bronze.csv')
